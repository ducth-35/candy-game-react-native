...
const useGameLogic = (data: any[][], setData: (data: any) => any) => {
  ...
  const handleSwipe = async (
    ...
    if (
      ...
      const targetTileAnimtionX = Animated.timing(
      ...
      const targetTileAnimtionY = Animated.timing(
      ...
      const sourceTileAnimtionX = Animated.timing(
      ...
      const sourceTileAnimtionY = Animated.timing(
